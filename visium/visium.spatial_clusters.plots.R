...
neighborhoods <- names(neighborhood_colors)
...
for (r in resolutions){
  ...
  plot_list <- lapply(sample_barcodes, function(sample){
    ...
    SpatialDimPlot(obj, images = image_id, group.by = res, crop = TRUE) +
      labs(title = sample) +
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.all_samples.', res, ".svg"), width=48, height=32)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.all_samples.', res, ".png"), width=48, height=32, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.normal_skin.', res, ".svg"), width=48, height=32)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.normal_skin.', res, ".png"), width=48, height=32, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.hs.', res, ".svg"), width=32, height=16)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.hs.', res, ".png"), width=32, height=16, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.ad_ls.', res, ".svg"), width=32, height=16)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.ad_ls.', res, ".png"), width=32, height=16, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.psoriasis_ls.', res, ".svg"), width=18, height=18)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.psoriasis_ls.', res, ".png"), width=18, height=18, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.all_inflm.', res, ".svg"), width=36, height=18)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.all_inflm.', res, ".png"), width=36, height=18, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.bcc_tumor.', res, ".svg"), width=36, height=16)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.bcc_tumor.', res, ".png"), width=36, height=16, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.scc_tumor.', res, ".svg"), width=36, height=16)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.scc_tumor.', res, ".png"), width=36, height=16, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
  ...
  svglite(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.all_tumor.', res, ".svg"), width=36, height=36)
  print(spatial_cluster_panel)
  dev.off()

  png(paste0("figures/visium/cluster_spatial/", run_prefix, '.cluster_spatial.all_tumor.', res, ".png"), width=36, height=36, units = 'in', res=300)
  print(spatial_cluster_panel)
  dev.off()
